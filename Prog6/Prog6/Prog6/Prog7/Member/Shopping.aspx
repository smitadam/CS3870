<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Shopping.aspx.cs" Inherits="Prog6.Prog7.Member.Shopping" %>
...
<head runat="server">
    ...
    <title>CS3870 - Fall 2019 - Program 7 - Shopping</title>
</head>
    <body>
        ...
        <table align="center" style:="" width="60%">
            ...
            <tr>
                <td class="auto-style8">
                    <asp:Button ID="btnCompute" runat="server" CssClass="btn" Height="32px" OnClick="btnCompute_Click" style="font-weight: 700" Text="Calculate" Width="121px" />
                </td>
                <td>
